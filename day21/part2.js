...
// console.log([...ingredientAllergenMap.entries()])

sortedIngredients = [...ingredientAllergenMap.entries()].
  sort(([ingredient1, allergen1], [ingredient2, allergen2]) => allergen1.localeCompare(allergen2)).
  map(([ingredient, allergen]) => ingredient);

console.log(sortedIngredients.join(','));
