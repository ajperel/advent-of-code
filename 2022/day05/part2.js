/**
 * Solutions for Advent of Code 2022, Day 5, Part 2.
...
rearrangementProcedure.forEach(({moveNum, from, to}) => {
  let stack = currentStacks[from].splice(currentStacks[from].length - moveNum, moveNum);
  currentStacks[to].push(...stack);
