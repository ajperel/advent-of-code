/**
 * Solutions for Advent of Code 2021, Day 4, Part 2.
  ...
  call(num) {
    this.board.some((row, rowIndex) => {
      ...
      if(columnIndex > -1) {
        ...
        if (this.columnCalledCount[columnIndex] == this.nCols) {
          this.won = true;
        }
...
console.log({
  ...
  lastWinningNumber,
  lastWinningBoard,
  unmarkedSum: lastWinningBoard.sumUncalled(),
  answer: lastWinningNumber * lastWinningBoard.sumUncalled()
});
